		...
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="login-ruleForm">
			...
			<el-form-item prop="password">
				<div class="flex flex-direction align-items-center" style="margin: 0.6rem 1.6rem 0 1.6rem;border-bottom: 1px #ffffff solid;height: 0.8rem">
					...
					<el-input v-model="ruleForm.password" placeholder="请输入登录密码" @keyup.enter.native="goLogin()" show-password style="width: 60%;background: rgba(255,255,255,0);border: none;height: 100%;color: #ffffff;outline: none">
					</el-input>
				</div>
			</el-form-item>
		</el-form>
